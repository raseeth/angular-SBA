...
import { TasksModelBuilder } from 'src/app/service/task/task-model.builder';
import { of } from 'rxjs';
...
import { ProjectModelBuilder } from 'src/app/service/project/project-model.builder';
import { UsersModelBuilder } from 'src/app/service/user/user-model.builder';
...
describe('AddTaskComponent', () => {
  ...
  it('should call task get on ngOnInit as expected for update', () => {
    // Arrange
    mockActivatedRoute = {
      params: of({ "id": 123 })
    };
  ...
  it("should call the modalservice component as expected for project search", () => {
    // Arrange
    component.ngOnInit();
  ...
  it("should call the modalservice component as expected for user search", () => {
    // Arrange
    component.ngOnInit();
  ...
  it("should call the modalservice component as expected for task search", () => {
    // Arrange
    component.ngOnInit();
